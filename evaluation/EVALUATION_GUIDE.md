...
There is no simulation mode or manual scorecard. The checked-in challenge and routing JSON files are the sources of truth for questions, complete SDK expected answers, intended sources, and intended measures or objects.
...
| Lakehouse attached | `step3_lakehouse_added` | Challenge |
| Lakehouse tuned | `step4_lakehouse_tuned` | Challenge |
| Final standard evaluation | `step5_final` | Challenge |
| Prepared routing marts | `step5_routing` | Routing |

Challenge runs contain 16 prompts: eight original questions and eight paraphrases. The routing run contains three prompts. Step 6 ontology questions remain a qualitative extension unless a separate ontology dataset is added.
